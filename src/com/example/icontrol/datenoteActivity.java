...
public class datenoteActivity extends Activity implements OnScrollListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datenote);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		while (c.moveToNext()) {
			...
			myIntent.setClass(datenoteActivity.this, noteEdit.class);
